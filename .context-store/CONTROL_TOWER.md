...
## 当前焦点
- **2026-08-15**：SPEC v2.0 已重构；**S2 数据统一 ✅ / S3 账号持久化 ✅ / S4 收藏跨设备 ✅ / S5 pending 上传治理 ✅ / S6 对话体验 ✅ —— S2–S6 全部完成并推送**；43 子测试全绿。
- **下一步**：SPEC §11 后置项（短信网关生产化 / 微信凭据 / V4.1 券核销 BFF / V4.2 商户入驻 / V4.3 分润对账 / 增长实验 / 小程序壳 / V5 规模化出海）——大部分需 Robin 决策（商家签约、生产密钥、支付项目），不擅自推进。
